...
class SecondaryMuscleDAO():
    ...
    def insertSecondaryMuscle(self, muscle_id, muscle_description):
    ...
    def deleteSecondaryMuscle(self, exercise_id, muscle_id):
        cur = self.conn.cursor()
        query = "delete from exercise_secondary_muscles where exercise_id = %s AND id = %s"
